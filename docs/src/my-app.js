...
</dom-module>`;document.head.appendChild($_documentContainer$3.content);Polymer$1({is:"paper-icon-button",hostAttributes:{role:"button",tabindex:"0"},behaviors:[PaperInkyFocusBehavior],properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(newValue,oldValue){var label=this.getAttribute("aria-label");if(!label||oldValue==label){this.setAttribute("aria-label",newValue)}}});const $_documentContainer$4=document.createElement("div");$_documentContainer$4.setAttribute("style","display: none;");$_documentContainer$4.innerHTML=`<iron-iconset-svg name="my-icons" size="24">
  <svg>
    <defs>
      <g id="arrow-back">
...
</iron-iconset-svg>`;document.head.appendChild($_documentContainer$4);setPassiveTouchGestures(!0);setRootPath(Polymer.rootPath);class MyApp extends PolymerElement{static get template(){return html`
      <style>
        :host {
